      ...
      <main>
        <section className="relative overflow-hidden border-b border-white/10">
          ...
          <div className="relative mx-auto grid min-h-[520px] max-w-7xl items-center gap-10 px-5 py-20 sm:px-8 lg:grid-cols-[1.1fr_.9fr]">
            <div>
              <p className="text-xs uppercase tracking-[0.42em] text-[#c4a45f]">Coleccion disponible</p>
              <h1 className="mt-5 max-w-3xl font-brand text-5xl leading-[.92] text-white sm:text-7xl lg:text-8xl">
                El tiempo, elegido con intencion.
              </h1>
        ...
        <section className="mx-auto max-w-7xl px-5 py-16 sm:px-8 sm:py-24">
          ...
          <div className="mb-12 rounded-[2rem] border border-white/10 bg-white/[0.04] p-4 shadow-[0_24px_80px_rgba(0,0,0,.22)] sm:p-5">
            <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-[1.35fr_.8fr_.8fr_.7fr_.7fr_.8fr]">
              ...
              <label className="block">
                ...
                >
                  ...
                  <option value="condition_desc">Mejor condicion</option>
                </select>
              </label>
            </div>
            <div className="mt-3 flex flex-wrap items-center gap-3">
              <label className="flex items-center gap-2 text-sm text-[#aaa69d]">
                <span>Condicion minima</span>
                <select
          ...
          {state.status === "loading" && <p className="py-24 text-center text-[#aaa69d]">Preparando la coleccion...</p>}
          {state.status === "error" && <p className="rounded-2xl border border-white/10 bg-white/5 p-8 text-center text-[#c8c1b5]">No pudimos cargar el catalogo. Intenta de nuevo en unos minutos.</p>}
          {state.status === "ready" && !state.items.length && <p className="rounded-2xl border border-white/10 bg-white/5 p-10 text-center text-[#aaa69d]">Muy pronto habra nuevas piezas disponibles.</p>}
